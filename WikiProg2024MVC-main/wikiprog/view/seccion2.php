                ...
                <div class="card-body">
                    ...
                    <?php if ($_SESSION['stop'] >= 3): ?>
                        <div class="alert alert-danger" role="alert">
                            Demasiados Intentos Fallidos. Usa el código de verificación: <strong><?php echo $_SESSION['verification_code']; ?></strong>
                        </div>
                        ...
                        <form method="post" id="formulario-verificacion">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="verification_code" name="verification_code"
                                    placeholder="Ingresa el código de verificación" required aria-label="Código de Verificación">
                            </div>
